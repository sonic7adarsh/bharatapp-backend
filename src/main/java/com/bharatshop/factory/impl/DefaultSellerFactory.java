    ...
    public SellerProductOps products() {
        return new SellerProductOps() {
            ...
            public Product create(String storeId, Product product) {
                ...
                product.setActive(false); // Default to inactive for new products
        ...
        return new SellerStoreOps() {
            ...
            public Store updatePartial(String id, java.util.Map<String, Object> changes) {
                return storeRepository.findById(id).map(entity -> {
                    ...
                    if (changes.containsKey("city")) entity.setCity((String) changes.get("city"));
                    ...
                    if (changes.containsKey("address")) {
                        ...
                        if (addrObj instanceof Map) {
                            ...
                            if (addr.containsKey("full")) entity.setFullAddress((String) addr.get("full"));
                            if (addr.containsKey("shopNo")) entity.setShopNo((String) addr.get("shopNo"));
                            if (addr.containsKey("building")) entity.setBuilding((String) addr.get("building"));
                            if (addr.containsKey("street")) entity.setStreet((String) addr.get("street"));
                            if (addr.containsKey("area")) entity.setArea((String) addr.get("area"));
                            if (addr.containsKey("city")) entity.setCity((String) addr.get("city"));
                            if (addr.containsKey("pincode")) entity.setPincode((String) addr.get("pincode"));
                            if (addr.containsKey("lat")) {
                                Object lat = addr.get("lat");
                                if (lat instanceof Number) entity.setLat(((Number) lat).doubleValue());
                            }
                            if (addr.containsKey("lng")) {
                                Object lng = addr.get("lng");
                                if (lng instanceof Number) entity.setLng(((Number) lng).doubleValue());
                            }
                        }
                    }
                    ...
                    // Address fields
                    s.setFullAddress(entity.getFullAddress());
                    s.setShopNo(entity.getShopNo());
                    s.setBuilding(entity.getBuilding());
                    s.setStreet(entity.getStreet());
                    s.setCity(entity.getCity());
                    s.setPincode(entity.getPincode());
                    s.setLat(entity.getLat());
                    s.setLng(entity.getLng());
